...
const RegistrationPage = () => {
    ...
    const submit=  ()=>{
        ...
        setEmail("");
        setPassword("");
         axios.post('http://localhost:8000/persons',{id:Date.now(),username,email,password})
        .then(res=>{
  ...
  return (
    <div>
        <h3 className='mb-8 font-bold font-mono text-fuchsia-300'>REGISTER</h3>
        <form action="">
        <div>
...
<div className='mt-4'>
<button className="btn w-60 h-8 btn-outline btn-primary" value={password} onClick={submit}>Register</button>
</div>
</form>
    </div>
  )
